...
echo H.264-QSV自動エンコード・字幕埋め込み実行バッチ %STR_Version%
rem v2.46to2.47:Caption2Assのパラメータを変更.
rem v2.45to2.46:Caption2Assの実行方法を変えて実行時間を少し短縮.
...
set PARAM_VideoOptions=-e qsv_h264 -q 30 -r 23.976 --cfr --h264-level=4.0 --h264-profile=high -x target-usage=3:gop-ref-dist=4:gop-pic-size=32:async-depth=4
set PARAM_AudioOptions=-a 1 -E faac -6 stereo -D 0 --gain 0
if "%enc_type%"=="720pa" (
set PARAM_FileDesc=720p qsv_h264 AAC
...
set PARAM_FileDesc=720i qsv_h264 AAC
set PARAM_PictureOptions=-Y 720 --crop 0:0:0:0
